---
title: "Sensitivity of CO2 emission rate to temperature in cranberry soils"
author: "Dr.Wilfried Dossou-Yovo"
date: "13/02/2022"
output:
...
h <- broom::tidy(model_fit, conf.int = TRUE) |>
  ...
  geom_errorbarh(aes(xmin = conf.low, xmax = conf.high), height = 0.1,
                 size=0.5) +
  scale_x_continuous(breaks = c(-0.6, -0.4, -0.2, 0.0, 0.2), labels = c("–0.6", "–0.4", "–0.2", "0.0", "0.2")) +
...
figure <- ggarrange(plot1, plot2, plot3, plot4, plot5, plot6,
                    ...
                    ncol = 2, nrow = 3)
figure
ggsave("figures/Soil description.png", width = 9, height = 6, dpi = 600)# export plot high resolution
```
